...
public Console(JTextArea ta, int ml)  {
    if(ml<1) { try {
		throw new Exception("Maximum lines of "+ml+" in TextAreaOutputStream constructor is not permitted");
	} catch (Exception exception) {
		System.err.println( exception.getMessage());
		System.err.println("Exception:"+ exception.getCause());
		System.exit(-1);
	} }
    textArea=ta;
    maxLines=ml;
